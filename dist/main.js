...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addContactContent\": () => (/* binding */ addContactContent)\n/* harmony export */ });\n/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./menu */ \"./src/pages/menu.js\");\n\n\nconst addContactContent = () => {\n  const content = document.getElementById('content');\n\n  // add contact content to DOM\n  const contentDiv = (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('div', { id: \"contactContent\" }, content);\n  (() => {\n    const inputPattern = 'pattern=\"^(?![\\s.]+$)[0-9a-zA-Z\\s.]*$\"';\n    (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('h1', '', contentDiv, 'Contact us');\n    (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('p', '', contentDiv, \"Fill in the form below or call us on 518-783-7239 to get in touch. We would be happy to answer your questions & assist you in any way we can.\");\n    (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('form', { action: '#', id: \"form\" }, contentDiv,\n      (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('p', \"\", '',\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('label', { for: 'name', class: 'required' }, '', \"Name: \"),\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('input', { inputPattern, required: true, id: 'name', maxlength: '24' }, '')\n      ),\n      (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('p', \"\", '',\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('label', { for: 'email', class: 'required' }, '', \"Email: \"),\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('input', { inputPattern, required: true, id: 'email', type: 'email' }, '')\n      ),\n      (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('p', \"\", '',\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('label', { for: 'subject', class: 'required' }, '', \"Subject: \"),\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('input', { inputPattern, required: true, id: 'subject', maxlength: '32' }, '')\n      ),\n      (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('p', \"\", '',\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('label', { for: 'messageArea', class: 'required' }, '', \"Message: \"),\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('textarea', { inputPattern, id: 'messageArea', cols: \"30\", rows: \"10\", placeHolder: 'Type your message here...' }, '')\n      ),\n      (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('button', { type: 'submit' }, '', 'Submit')\n    )\n  })();\n\n  (() => {\n    let name = '';\n    let email = '';\n    let subject = '';\n    const form = document.getElementById('form');\n    form.addEventListener('submit', (e) => {\n      e.preventDefault;\n      name = form.name.value;\n      email = form.email.value;\n      subject = form.subject.value;\n      displayMessage();\n    });\n\n    const displayMessage = () => {\n      // clear form except for H1\n      const contactHeading = document.querySelector('#contactContent h1');\n      while (contactContent.children.length > 1) {\n        contactContent.removeChild(contactContent.lastChild);\n      }\n      // modify H1 & add new paragraph with <span>'s\n      contactHeading.innerText = `Thank you for contacting us `;\n      (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('span', '', contactHeading, name + \"!\");\n      (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('p', '', contentDiv, 'We have received your message with subject: ',\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('span', '', '', '\"' + subject + '\"'),\n        ' and will respond via ',\n        (0,_menu__WEBPACK_IMPORTED_MODULE_0__.elFactory)('span', '', '', email),\n        ' within 24 hours.'\n      )\n    }\n  })();\n};\n\nconst contact = () => {\n  addContactContent();\n};\n\n//# sourceURL=webpack://10-restaurant-page/./src/pages/contact.js?");
